            ...
            <div className="text flex items-center justify-center">
              <div className="content md:w-5/6 w-full">
                ...
                <div className="body1 text-center md:mt-7 mt-5">
                  ...
                  centuries-old craftsmanship, reimagined for today
                  {String.raw`'s`} discerning woman.
                </div>
                <div className="body1 text-center mt-5">
                  ...
                  Whether you{String.raw`'re`} a fashion enthusiast or
                  appreciate handmade quality, we invite you to explore our
                  story through every stitch and print.
                </div>
                <div className="body1 text-center mt-5">
                  Join our creative journey on{" "}
                  <a
                    href="https://www.facebook.com/blockistry.pk"
                  ...
                  and{" "}
                  <a
                    href="https://www.instagram.com/block.istry?utm_source=qr&igsh=MXVmcHhpNXkxNzJvcw=="
                    className="text-primary"
                  >
